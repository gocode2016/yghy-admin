...
class Welcome extends PureComponent {
  ...
  handleInit(){
    ...
    osCtx.textAlign = "center";
		...
		osCtx.fillText("阳光花艺后台管理系统" , this.osCanvas.width/2, this.osCanvas.height/2);
  ...
  getLogoData = ()=>{
    ...
    osCtx.clearRect(0,0,this.osCanvas.width,this.osCanvas.height);
		...
		osCtx.fillText("后台" , 210 , this.osCanvas.height/2);
		osCtx.font="38px 微软雅黑,黑体 bold";
		osCtx.fillStyle="#405159";
		osCtx.fillText("阳光花艺" , 80 , this.osCanvas.height/2);
		osCtx.fillText("管理系统" , 360, this.osCanvas.height/2);
